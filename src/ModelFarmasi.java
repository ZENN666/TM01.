...
public class ModelFarmasi {
    ...
    private String i_artilce;
    private String i_cogs;
    private String i_kdsell;
    private String i_sell;
    ...
    public String getI_artice() {
        return i_artilce;
    }

    public void setI_artice(String i_artice) {
        this.i_artilce = i_artice;
    }
    ...
    public ModelFarmasi(String i_code, String g_code, String i_supp, String i_barcode, String i_name, String i_qty, String i_qtyname, String i_unit, String i_size, String i_color, String i_brands, String i_artice, String i_cogs, String i_kdsell, String i_sell, String i_status, String id) {
        this.i_code = i_code;
        this.g_code = g_code;
        this.i_supp = i_supp;
        this.i_barcode = i_barcode;
